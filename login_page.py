...
class FormWidget(FormWidgetIF):
    ...
    def setupUi(self, login_page):
        ...
        self.vertical_layout = QVBoxLayout(login_page)
        ...
        self.username_line_edit = QLineEdit(login_page)
        self.username_line_edit.setPlaceholderText("Enter your Username")
        self.username_line_edit.setSizePolicy(self.get_size_policy(self.username_line_edit, QSizePolicy.Expanding, QSizePolicy.Preferred))
        self.username_line_edit.setFont(QFont('', 16))
        ...
        self.password_line_edit = QLineEdit(login_page)
        self.password_line_edit.setPlaceholderText("Enter your Password")
        self.password_line_edit.setSizePolicy(self.get_size_policy(self.password_line_edit, QSizePolicy.Expanding, QSizePolicy.Preferred))
        self.password_line_edit.setFont(QFont('', 16))
        self.password_line_edit.setEchoMode(QLineEdit.Password)
        self.form_layout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.password_line_edit)

        self.horizontal_layout = QHBoxLayout(login_page)

        self.form_layout2 = QFormLayout(login_page)
